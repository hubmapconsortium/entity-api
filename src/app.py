...
def get_entity_by_id(id):
    ...
    if entity_dict['entity_class'] == 'Collection':
        bad_request_error("Please use /collections/<id> for querying a collection")
...
def get_collection(id):
    ...
    if user_info['data_access_level'] == 'public': 
        if ('has_doi' not in entity_dict) or (not entity_dict['has_doi']):
            not_found_error("Could not find this collection with the given id")
