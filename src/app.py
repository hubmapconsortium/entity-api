...
def update_entity(id):
    ...
    if MEMCACHED_MODE:
        ...
        cache_key = f'{MEMCACHED_PREFIX}{id}'
        complete_entity_result_cache_key = f'{_memcached_prefix}_complete_entity_result_{id}'
        normalized_entity_result_for_response_cache_key = f'{_memcached_prefix}_normalized_entity_result_for_response_{id}'

        memcached_client_instance.delete(cache_key)
        memcached_client_instance.delete(complete_entity_result_cache_key)
        memcached_client_instance.delete(normalized_entity_result_for_response_cache_key)

        logger.info(f"Deleted cache of key: {cache_key}, {complete_entity_result_cache_key}, and {normalized_entity_result_for_response_cache_key} after entity update via PUT call")
        ...
        for child_uuid in children_uuid_list:
            ...
            logger.info(f"Deleted direct descendant cache of key: {cache_key},  {complete_entity_result_cache_key}, and {normalized_entity_result_for_response_cache_key}")
