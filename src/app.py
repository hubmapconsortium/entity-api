...
def get_entity_by_id(id):
    ...
    final_result = schema_manager.get_complete_entity_result(normalized_entity_class, entity_dict)
...
def update_entity(id):
    ...
    result_dict = schema_manager.get_complete_entity_result(normalized_entity_class, updated_entity_dict)
...
def create_collection(normalized_entity_class, json_data_dict):
    ...
    # generated by `on_read_trigger` to have a complete result
    # Will also filter the result based on schema
    return schema_manager.get_complete_entity_result(normalized_entity_class, entity_dict)
