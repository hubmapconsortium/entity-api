...
def get_ancestor_organs(id):
    ...
    # A bit validation
    supported_entity_types = ['Sample', 'Dataset', 'Publication']
...
def get_entity_by_id(id):
    ...
    if bool(request.args):
        ...
        if property_key is not None:
            ...
            if property_key == 'status' and normalized_entity_type not in ['Dataset', 'Publication']:
...
def add_datasets_to_collection(collection_uuid):
    ...
    for dataset_uuid in dataset_uuids_list:
        ...
        if entity_dict['entity_type'] not in ['Dataset', 'Publication']:
...
def get_dataset_latest_revision(id):
    ...
    if normalized_entity_type not in ['Dataset', 'Publication']:
