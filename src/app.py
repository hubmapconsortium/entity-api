...
"""
Retrive the full tree above the referenced entity
...
def get_entity_provenance(id):
    ...
    provenance_data = get_provenance_history(uuid, depth)
...
def get_provenance_history(uuid, depth=None):
    ...
    known_attribute_map = {
        'group_name': ProvConst.HUBMAP_PROV_GROUP_NAME, 
        'group_uuid': ProvConst.HUBMAP_PROV_GROUP_UUID,
        'created_by_user_displayname': ProvConst.HUBMAP_PROV_USER_DISPLAY_NAME, 
        'created_by_user_email': ProvConst.HUBMAP_PROV_USER_EMAIL,
        'created_by_user_sub': ProvConst.HUBMAP_PROV_USER_UUID, 
        'last_modified_timestamp': ProvConst.HUBMAP_MODIFIED_TIMESTAMP
    }
    ...
    for rel_record in record['relationships']:
        ...
        if rel_record['rel_data']['type'] == 'HAS_METADATA':
            ...
            provenance_data = {
                ProvConst.PROV_GENERATED_TIME_ATTRIBUTE : entity_timestamp_json
            }
            ...
            organization_uri = build_uri('hubmap','organization',organization_record[ProvConst.HUBMAP_PROV_GROUP_UUID])
            doc_agent = None
            doc_org = None
            ...
            other_attributes = {
                ...
                ProvConst.HUBMAP_DISPLAY_DOI_ATTRIBUTE : from_node['hubmap_id'],
