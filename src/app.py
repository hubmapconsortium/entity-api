...
def update_entity(id):
    ...
    if MEMCACHED_MODE:
        ...
        cache_keys = [
            ...
            f'{_memcached_prefix}_complete_entity_result_{id}{"_".join(properties_to_skip)}_skipped',
            f'{_memcached_prefix}_normalized_entity_result_{id}'
        ]

        memcached_client_instance.delete_many(cache_keys)

        logger.info(f"Deleted cache of key: {', '.join(cache_keys)} after entity update via PUT call")
        ...
        for child_uuid in children_uuid_list:
            cache_keys = [
                ...
                f'{_memcached_prefix}_complete_entity_result_{child_uuid}{"_".join(properties_to_skip)}_skipped',
                f'{_memcached_prefix}_normalized_entity_result_for_response_{child_uuid}'
            ]
